...
public class GameTokenTests {
	...
	@Test public void testValidConstructor1(){
		GameToken testToken = new GameToken("square", Color.BLUE);
		assertTrue(testToken.getType().equals("square"));
	}
	...
	@Test public void testValidEquals1(){
		GameToken testToken = new GameToken("square", Color.BLUE);
		assertTrue(testToken.equals(new GameToken("square", Color.BLUE)));
	}
	...
	@Test public void testValidEquals2(){
		GameToken testToken1 = new GameToken("square", Color.BLUE);
		testToken1.setFound(false);
		GameToken testToken2 = new GameToken("square", Color.BLUE);
	...
	@Test public void testInvalidEquals1(){
		GameToken testToken = new GameToken("square", Color.BLUE);
		assertTrue(!testToken.equals(new GameToken("squar", Color.BLUE)));
	}
	...
	@Test public void testInvalidEquals2(){
		GameToken testToken = new GameToken("square", Color.BLUE);
		assertTrue(!testToken.equals(new GameToken("square", Color.BLACK)));
	}
